 ...
 * @author USUARIO
 */
public class sopaplanetaseasy extends javax.swing.JFrame {

    /**
     * Creates new form ventana2
     */
    private String name = null;
    public sopaplanetaseasy(String user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        siguiente.setBackground(new java.awt.Color(250, 250, 250));
        siguiente.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 12)); // NOI18N
        siguiente.setForeground(new java.awt.Color(255, 153, 255));
    ...
    private void siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteActionPerformed
        ...
        sopaplanetasmedium hola5 = new sopaplanetasmedium(name);//Una instancia
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sopaplanetaseasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sopaplanetaseasy(null).setVisible(true);
            }
        });
    }
