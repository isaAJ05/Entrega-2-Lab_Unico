...
public class rompecabezas02 extends javax.swing.JFrame implements ActionListener {
    ...
    ImageIcon pp1 = new ImageIcon(CL.getResource("IMGrompecabezas/12.jpg"));
    ImageIcon pp2 = new ImageIcon(CL.getResource("IMGrompecabezas/11.jpg"));
    ImageIcon pp3 = new ImageIcon(CL.getResource("IMGrompecabezas/10.jpg"));
    ImageIcon pp4 = new ImageIcon(CL.getResource("IMGrompecabezas/9.jpg"));
    ImageIcon pp5 = new ImageIcon(CL.getResource("IMGrompecabezas/8.jpg"));
    ImageIcon pp6 = new ImageIcon(CL.getResource("IMGrompecabezas/7.jpg"));
    ImageIcon pp7 = new ImageIcon(CL.getResource("IMGrompecabezas/6.jpg"));
    ImageIcon pp8 = new ImageIcon(CL.getResource("IMGrompecabezas/5.jpg"));
    ImageIcon pp9 = new ImageIcon(CL.getResource("IMGrompecabezas/4.jpg"));
    ImageIcon pp10 = new ImageIcon(CL.getResource("IMGrompecabezas/3.jpg"));
    ImageIcon pp11 = new ImageIcon(CL.getResource("IMGrompecabezas/2.jpg"));
    ImageIcon pp12 = new ImageIcon(CL.getResource("IMGrompecabezas/1.jpg"));

    public rompecabezas02() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rompecabezas02().setVisible(true);
            }
        });
    }
