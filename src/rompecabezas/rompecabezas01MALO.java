...
public class rompecabezas01MALO extends javax.swing.JFrame implements ActionListener {
    ...
    public rompecabezas01MALO(String name) {
        this.user=name;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rompecabezas01MALO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rompecabezas01MALO(null).setVisible(true);
            }
        });
    }
