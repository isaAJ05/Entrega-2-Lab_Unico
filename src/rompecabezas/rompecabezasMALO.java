...
public class rompecabezasMALO extends javax.swing.JFrame {
  private String user;
    public rompecabezasMALO(String name) {
        this.user = name;
...
//        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        rompecabezas01MALO a = new rompecabezas01MALO(user);
        a.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        rompecabezas02MALO a = new rompecabezas02MALO(user);
        a.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rompecabezasMALO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rompecabezasMALO(null).setVisible(true);
            }
        });
    }
